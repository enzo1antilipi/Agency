    ...
    <div >
      ...
      <div className={styles.imgContainer}>
        ...
        <div className={styles.content}>
          <h1>Transformamos ideas en experiencias únicas</h1>
          <h3>Diseño web creativo y desarrollo a medida para impulsar tu negocio</h3>
          <div className={styles.buttonContainer}>
            <button className={styles.button}>Ver proyectos</button>
            <button className={styles.buttonContact}>Contactar</button>
        </div>
  </div>
      </div>
      <section className={styles.SectionService}>
          <h3>Servicios</h3>
          <h1>Esto es lo que hacemos mejor</h1>
      ...
      <section className={styles.SectionAbout}>
        <h3>Quienes somos?</h3>
        <h1>El equipo detras de las soluciones digitales</h1>
     ...
     <div className={styles.profileContainer}>
      ...
      <div className={styles.profileInfo}>
        <h2>Romina Yudica</h2>
        <h4>Diseñadora Gráfica especializada en Web</h4>
        <p>
          Lorem ipsum dolor sit amet. Sed expedita illum non alias ipsam non dolores assumenda non commodi officia ex fuga earum sit nostrum eaque cum unde laboriosam. Cum dolore dolorum eum galisum corporis sit maiores.
        </p>
  ...
  <div className={styles.projectsContainer}>
    ...
    <div className={styles.projectCard}>
      ...
      <div className={styles.projectInfo}>
        <h2>Proyecto 1</h2>
        <p>Diseño web</p>
        <p>Descripción breve del proyecto. Explica su propósito y tecnología usada.</p>
      </div>
    </div>
